<?php
	...
	if(mysql_num_rows($query)&gt;0){        //se c'è una persona con quel nome nel db allora loggati
		...
		echo "Login effettuato con successo"; // altrimenti esce scritta a video questa stringa di errore
	}else{
	echo "Errore: non ti sei loggato con successo"; // altrimenti esce scritta a video questa stringa di errore
	}
?>